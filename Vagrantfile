...
Vagrant.configure("2") do |config|
	...
	#    Vagrant VM just to remap ports.
                ...
                config.vm.network :forwarded_port, guest: 3906, host: 3906
                config.vm.network :forwarded_port, guest: 3907, host: 3907
                config.vm.network :forwarded_port, guest: 3908, host: 3908
